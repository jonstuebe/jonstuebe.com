export default function PrivacyPolicy() {
  return (
    <div className="flex flex-col p-4 mb-4 flex-1 m-auto relative prose">
      ...
      <p>
        Jon Stuebe built the Quench app as a Free app. This SERVICE is provided
        by Jon Stuebe at no cost and is intended for use as is.
      </p>{" "}
      <p>
      ...
      <p>
        ...
        Terms and Conditions, which are accessible at Quench unless otherwise
      ...
      <h3 className="text-base text-gray-500 text-center mb-4 font-medium">
