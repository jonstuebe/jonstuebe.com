...
meta:
  title: Uses
  description: Some of the various things I use
...
<Layout>
  <Header />
    <main className="pb-24">
      <h1 className="text-5xl lg:text-8xl tracking-tight lg:py-8 py-8 text-center motion-safe:animate-text-in-slow select-none">
        Uses
      </h1>
